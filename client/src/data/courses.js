...
title: "DevOps",
location: "Calicut",
desc: "Master the tools and practices that power modern software delivery and cloud infrastructure. Gain practical experience with industry-standard tools and workflows used to develop, deploy, and manage modern applications. Learn Linux, Git, Docker, Kubernetes, CI/CD, cloud platforms, Infrastructure as Code, and monitoring tools through hands-on projects and real-world scenarios to build a successful career in DevOps and Cloud Engineering.",
duration: "6 months",
fee: "₹89,999",
rating: "4.8",
img: list,
